...
export function useAppHook() {
	...
	const handleData = useCallback(async () => {
		...
		console.log("referenceSeriesRaw", referenceSeriesRaw)
		...
		try {
			...
			console.log({ fillingRateDayRaw, fillingRatePeriodRaw })
			if (
			...
			console.log({ surfaceDayRaw, surfacePeriodRaw })
			...
			console.log({ volumeDayRaw, volumePeriodRaw })
			...
			const fillingRate = {
				[DurationTypes.DAY]: {
					...
					dayByYear: fillingRateDayByYEar,
				},
				[DurationTypes.PERIOD]: {
					period: fillingRatePeriodRaw,
					periodByYear: fillingRatePeriodByYear,
				},
			}
			const surface = {
				[DurationTypes.DAY]: {
					day: surfaceDayRaw,
					dayByYear: surfaceDayByYear,
				},
				[DurationTypes.PERIOD]: {
					period: surfacePeriodRaw,
					periodByYear: surfacePeriodByYear,
				},
			}
			...
			const volume = {
				[DurationTypes.DAY]: {
					day: volumeDayRaw,
					dayByYear: volumeDayByYear,
					dayFull: volumeDayFull[0],
				},
				[DurationTypes.PERIOD]: {
					period: volumePeriodRaw,
					periodByYear: volumePeriodByYear,

...
export const globalStyles = globalCss({
	...
	"@font-face": [
		...
		},
		{
			...
			fontStyle: "normal",
			fontWeight: "700",
			src: "url('../public/fonts/arial_bold.woff)",
		},
		{
			fontDisplay: "swap",
			fontFamily: "arial",
			fontStyle: "italic",
			fontWeight: "700",
			src: "url('../public/fonts/arial/arial_bold_italic.woff)",
		},
		{
			fontDisplay: "swap",
			fontFamily: "arial",
			fontStyle: "italic",
			fontWeight: "normal",
			src: "url('../public/fonts/arial/arial_italic.woff)",
		},
		{
			fontDisplay: "swap",
			fontFamily: "arial",
			fontStyle: "normal",
			fontWeight: "normal",
			src: "url('../public/fonts/arial/arial.woff)",
		},
	],
})
